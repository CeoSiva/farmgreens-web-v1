      ...
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-8 lg:px-16 lg:py-16 xl:px-24">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="mb-4 flex items-center gap-2">
              ...
              <span className="text-xl font-bold tracking-tight">FarmGreens</span>
            </Link>
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-zinc-400">
              Your trusted partner for organic, farm-fresh produce. Delivering health and purity straight from the soil to your table since 2026.
            </p>
          </div>

          {/* Links Column 1 */}
          <div>
            <h4 className="mb-4 text-sm font-semibold tracking-wide">Category</h4>
            <ul className="space-y-3 text-xs text-zinc-400">
              <li><Link href="/shop/vegetables" className="transition-colors hover:text-white">Fresh Vegetables</Link></li>
              <li><Link href="/shop/greens" className="transition-colors hover:text-white">Leafy Greens</Link></li>
              <li><Link href="/shop/batter" className="transition-colors hover:text-white">Traditional Batter</Link></li>
              <li><Link href="/shop/fruits" className="transition-colors hover:text-white">Organic Fruits</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs text-zinc-400">
              ...
              <li><Link href="/farms" className="transition-colors hover:text-white">Our Farms</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-xs text-zinc-400">
              <li><Link href="/faq" className="transition-colors hover:text-white">Help & FAQ</Link></li>
              <li><Link href="/shipping" className="transition-colors hover:text-white">Shipping Policy</Link></li>
              <li><Link href="/returns" className="transition-colors hover:text-white">Returns & Refunds</Link></li>
        ...
        <div className="mt-12 flex flex-col items-center justify-between border-t border-zinc-800 pt-8 md:mt-16 md:flex-row">
          <div className="flex flex-col items-center gap-4 text-xs text-zinc-500 md:flex-row md:gap-6">
            <span>&copy; {new Date().getFullYear()} FarmGreens Inc. All rights reserved.</span>
